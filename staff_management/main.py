...
FastAPI application for Staff Management
"""
...
app = FastAPI(
    title="Salon Booking System - Staff Service",
    description="Staff management and availability service",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def health_check():
    ...
    return {"status": "healthy", "service": "staff_management"}
