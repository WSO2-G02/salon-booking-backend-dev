"""
Service Management Service - Main Application
FastAPI application for Salon Service Management
"""
...
app = FastAPI(
    title="Salon Booking System - Service Management",
    description="Salon service management (haircut, coloring, etc.)",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def health_check():
    ...
    return {"status": "healthy", "service": "service_management"}
