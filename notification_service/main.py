...
FastAPI application for sending email notifications
"""
...
app = FastAPI(
    title="Salon Booking System - Notification Service",
    description="Email notification service for user registration, appointments, and more",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
...
async def startup_event():
    ...
    logger.info(f"SMTP configured for: {settings.SMTP_USER}")
